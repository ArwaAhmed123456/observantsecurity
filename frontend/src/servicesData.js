const servicesData = [
  ...
  },
  {
    ...
    content: [
      ...
      "Health & Safety Compliance: Ensuring all visitors adhere to site safety protocols and PPE requirements.",
      "Out-of-Hours Patrols: Regular foot and mobile patrols during vulnerable nighttime and weekend periods."
    ]
  },
  {
  ...
  },
  {
    ...
    content: [
      "Crowd Dynamics Management: Expert strategies to handle large volumes of attendees safely and prevent bottlenecking.",
      "VIP & Backstage Protection: Dedicated close protection and secure perimeter management for artists and special guests.",
      "Bag Searches & Screening: Rigorous entry protocols to prevent prohibited items from entering the venue.",
      "Incident Response: Medical emergency coordination and rapid intervention for anti-social behavior."
    ]
  },
  {
  ...
  },
  {
    ...
    description: "Protecting logistics centers to avoid any kind of theft and disruption.",
    content: [
      "Gatehouse Operations: Managing the flow of heavy goods vehicles and validating delivery manifests.",
      "Loss Prevention: Internal patrols and staff searches to minimize inventory shrinkage and stock theft.",
      "Perimeter Security: Ensuring fencing, loading bays, and external storage yards are secure against intrusions.",
      "Fire & Safety Watch: Monitoring the facility for fire hazards, water leaks, and other non-criminal threats to standard operations."
    ]
  }
];
